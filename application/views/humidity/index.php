          ...
          <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="chart" role="tabpanel" aria-labelledby="home-tab">
              <div class="col-md-12" height="80" width="100">
                <canvas id="humidityChart" class="w-100 h-100"></canvas>
              </div>              
            </div>
            <div class="tab-pane fade" id="table" role="tabpanel" aria-labelledby="profile-tab">
              <div class="table-responsive mt-3">
                <table id="humidityTable" class="table table-bordered table-striped w-100">
                  <thead>
                    <tr>
                      <th>Humidity</th>
                      <th></th>
...
<script src="<?= base_url('assets/js/humidity/humidity.js') ?>"></script>